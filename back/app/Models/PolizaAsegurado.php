...
class PolizaAsegurado extends Model
{
    ...
    protected $fillable = [
        ...
        'premio_individual',
        'importe_mensual_la',
        'importe_mensual_distribuidor',
        'porcentaje_descuento_distribuidor',
        'importe_mensual_origen',
        'alta_endoso_id',
        'baja_endoso_id',
        'fecha_alta_efectiva',
        'fecha_baja_efectiva',
    ...
    protected $casts = [
        ...
        'importe_mensual_la'                => 'decimal:2',
        'importe_mensual_distribuidor'      => 'decimal:2',
        'porcentaje_descuento_distribuidor' => 'decimal:2',
