...
class PolizaAdminPermiso extends Model
{
    ...
    protected $fillable = [
        ...
        'puede_bulk_bajas_global',
        'puede_procesar_bajas',
        'puede_editar_importes',
        'puede_ver_auditoria',
    ...
    protected $casts = [
        ...
        'puede_bulk_bajas_global'           => 'boolean',
        'puede_procesar_bajas'              => 'boolean',
        'puede_editar_importes'             => 'boolean',
