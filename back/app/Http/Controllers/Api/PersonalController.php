...
class PersonalController extends Controller
{
    ...
    public function update(Request $request, Persona $persona): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'capacidadVehiculoKg' => ['nullable', 'integer', 'min:0'],
            'estadoId' => ['nullable', 'integer', 'exists:estados,id'],
            'pago' => ['nullable', 'numeric'],
            'cbuAlias' => ['nullable', 'string', 'regex:/^\d{22}$/'],
            ...
            'cobradorCbuAlias' => ['nullable', 'string', 'regex:/^\d{22}$/'],
            ...
            'duenoCbuAlias' => ['nullable', 'string', 'regex:/^\d{22}$/'],
        ...
        $integerAssignments = [
            ...
            'unidadId' => 'unidad_id',
            'capacidadVehiculoKg' => 'capacidad_vehiculo_kg',
            'estadoId' => 'estado_id',
        ];
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $persona = Persona::create([
            ...
            'capacidad_vehiculo_kg' => $validated['capacidadVehiculoKg'] ?? null,
    ...
    protected function buildPersonaDetail(Persona $persona, bool $includePending = false): array
    {
        ...
        return [
            ...
            'capacidadVehiculoKg' => $persona->capacidad_vehiculo_kg,
