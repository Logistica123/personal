...
return [
    ...
    */
    ...
    'arca' => [
        ...
        'emisor_domicilio' => env('ARCA_EMISOR_DOMICILIO', 'San Cayetano 3470 - San Cayetano, Corrientes'),
        'emisor_fecha_inicio_actividades' => env('ARCA_EMISOR_FECHA_INICIO_ACTIVIDADES', ''),
